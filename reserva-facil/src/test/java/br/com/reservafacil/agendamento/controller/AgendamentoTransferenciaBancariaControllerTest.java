...
public class AgendamentoTransferenciaBancariaControllerTest {
	...
	AgendamentoTransferenciaBancaria agendamentoComSaldo;
	...
	ContaBancaria contaDestinoComNumeroForaDoPadrao;
	...
	public void antes() {
		...
		contaDestinoComNumeroForaDoPadrao = new ContaBancaria("1234-0", 100.0);
		...
		sujeito = new AgendamentoTransferenciaBancariaController(agendamentoDao);
	}

	@Test
	public void DEVE_EXIBIR_TELA_DE_ERRO_QUANDO_CONTA_DE_DESTINO_ESTIVER_INVALIDA() {

		dataDeAgendamento = new GregorianCalendar(2016, 9, 20);

		agendamentoComSaldo = new AgendamentoTransferenciaBancaria(contaOrigemComSaldo,
				contaDestinoComNumeroForaDoPadrao, valorTransferido, dataDeCadastro, dataDeAgendamento,
				tipoDeTransacaoA);

		assertEquals("tela-de-erro", sujeito.realizaAgendamento(agendamentoComSaldo));
	}
	...
	public void DEVE_REALIZAR_AGENDAMENTO_COM_TRANSACAO_DE_TIPO_A() {
		...
		verify(agendamentoDao, times(1)).insere(agendamentoComTransacaoTipoA);
	}
	...
	public void DEVE_REALIZAR_AGENDAMENTO_COM_TRANSACAO_DE_TIPO_B_COM_TAXA_DE_10_REAIS() {
		...
		verify(agendamentoDao, times(1)).insere(agendamentoComTransacaoTipoB);
	}
	...
	public void DEVE_REALIZAR_AGENDAMENTO_COM_TRANSACAO_DE_TIPO_C_COM_TAXA_DE_1_2_PORCENTO() {
		...
		verify(agendamentoDao, times(1)).insere(agendamentoComTransacaoTipoC);
	}
	...
	public void DEVE_REALIZAR_AGENDAMENTO_COM_TRANSACAO_DE_TIPO_D_COM_VALOR_ATE_25000_REAIS() {
		...
		verify(agendamentoDao, times(1)).insere(agendamentoComTransacaoTipoD);
	}
	...
	@Test
	public void DEVE_EXIBIR_LISTA_DE_AGENDAMENTOS_PARA_CONTA_DE_ORIGEM() {
		...
		assertEquals("lista-de-agendamentos", sujeito.listaTodosOsAgendamentos(agendamentoComSaldo, model));
		verify(agendamentoDao, times(1)).todosAgendamentos(contaOrigemComSaldo);
	}
}
